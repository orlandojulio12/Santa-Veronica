        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center ml-auto space-x-4">
                    ...
                    <button class="flex items-center px-4 py-2 text-gray-800 bg-white hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-300">

                        <x-nav-link href="#">
                            <i class="bi bi-cart-fill me-1"></i>
                            {{ __('Cart') }}
                            <span class="text-black rounded-full badge bg-dark ms-1">0</span>
                        </x-nav-link>
                    </button>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
