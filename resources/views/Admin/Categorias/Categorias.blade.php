        ...
        <div class="card-body">
            ...
            <table id="restaurantes" class="table table-striped nowrap" style="width:100%">
                <thead>
                    ...
                    <a class="float-right ml-6 btn btn-primary sm" href="{{route('Categorias.create')}}"><i class="fa fa-user-plus" aria-hidden ="true"></i></a>
                    @endif
                    <tr>
                        <td>Nombre</td>
                        @if ($usuario->hasRole('Admin'))
                    ...
                    @foreach ($cat as $c)
                        <tr>
                            ...
                            <td scope="col" class="text-center border">
                                ...
                                <form action="{{route('Categorias.edit',$c->id)}}" method="get">
                                    <button class="btn btn-warning"><i class="fas fa-edit" aria-hidden="true"></i></button>
                                </form> <br>
                                <form action="{{route('Categorias.showDeleteForm',$c->id)}}" method="get">
