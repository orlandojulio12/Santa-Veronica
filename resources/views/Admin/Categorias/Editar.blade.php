                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="nombre" placeholder="" value="{{ $categoria->nom_categoria }}" required><br>
                                ...
                                @else
                                    ...
                                    <select name="restaurante" class="form-control" id="restaurante" required>
                                        @foreach($restaurantes as $restaurante)
                                            <option value="{{ $restaurante->id }}" {{ $restaurante->id == $categoria->id_restaurante ? 'selected' : '' }}>{{ $restaurante->nom_rest }}</option>
                                        @endforeach
                                    </select>
                                @endif
                            </div>
