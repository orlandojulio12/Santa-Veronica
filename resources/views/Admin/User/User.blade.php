        ...
        <div class="card-body">
            ...
            <table id="usuarios" class="table table-striped nowrap" style="width:100%">
                <thead>
                    ...
                    <a class="float-right ml-6 btn btn-primary sm" href="{{route('admin.User.create')}}"><i class="fa fa-user-plus" aria-hidden ="true"></i></a>
                    @endif
                    <tr>
                        <td>Nombre</td>
                        <td>Correo</td>
                    ...
                    @foreach ($users as $u)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('admin.User.edit',$u->id)}}" method="get">
                                    <button class="btn btn-warning"><i class="fas fa-edit" aria-hidden="true"></i></button>
                                </form> <br>
                                <form action="{{route('admin.User.showDelete',$u->id)}}" method="get">
