...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Restaurantes',
            'route'         => 'admin.indexRest',
            'icon'        => 'fas fa-fw fa-utensils',
    
        ],
        [
            'text'        => 'Categorias',
            'route'         => 'admin.indexCat',
            'icon'        => 'fas fa-fw fa-list',
    
        ],
        [
            'text'        => 'Productos',
            'route'         => 'admin.indexProd',
            'icon'        => 'fas fa-fw fas fa-fish',
    
        ],
        [
            'text'        => 'Horarios',
            'route'         => 'admin.indexHorario',
